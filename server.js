...
export const biblicalProfiles = [
  { id: 1, name: "God", image: "https://speaktoheaven.comhttps://speaktoheaven.com/img/god.jpg", description: "Creator, Eternal, Almighty." },
  { id: 2, name: "Jesus Christ", image: "https://speaktoheaven.comhttps://speaktoheaven.com/img/jesus.jpg", description: "Teacher, Savior, Son of God." },
  { id: 3, name: "Holy Spirit", image: "https://speaktoheaven.comhttps://speaktoheaven.com/img/holyspirit.jpg", description: "Comforter, Advocate, Helper." },
  { id: 4, name: "Mary", image: "https://speaktoheaven.comhttps://speaktoheaven.com/img/mary.jpg", description: "Mother of Jesus, blessed among women." },
  { id: 5, name: "Moses", image: "https://speaktoheaven.comhttps://speaktoheaven.com/img/moses.jpg", description: "Prophet, leader of Israel." },
  { id: 6, name: "Abraham", image: "https://speaktoheaven.com/img/abraham.jpg", description: "Father of faith." },
  { id: 7, name: "Isaac", image: "https://speaktoheaven.com/img/isaac.jpg", description: "Child of promise." },
  { id: 8, name: "Jacob", image: "https://speaktoheaven.com/img/jacob.jpg", description: "Father of the twelve tribes." },
  { id: 9, name: "Noah", image: "https://speaktoheaven.com/img/noah.jpg", description: "Builder of the ark." },
  { id: 10, name: "Adam", image: "https://speaktoheaven.com/img/adam.jpg", description: "First man." },
  { id: 11, name: "Eve", image: "https://speaktoheaven.com/img/eve.jpg", description: "Mother of all living." },
  { id: 12, name: "King David", image: "https://speaktoheaven.com/img/david.jpg", description: "Poet, warrior, king." },
  { id: 13, name: "Solomon", image: "https://speaktoheaven.com/img/solomon.jpg", description: "King of wisdom." },
  { id: 14, name: "Isaiah", image: "https://speaktoheaven.com/img/isaiah.jpg", description: "Major prophet." },
  { id: 15, name: "Jeremiah", image: "https://speaktoheaven.com/img/jeremiah.jpg", description: "Prophet of warning and hope." },
  { id: 16, name: "Ezekiel", image: "https://speaktoheaven.com/img/eze.jpg", description: "Prophet of visions." },
  { id: 17, name: "Daniel", image: "https://speaktoheaven.com/img/daniel.jpg", description: "Interpreter of dreams." },
  { id: 18, name: "Elijah", image: "https://speaktoheaven.com/img/elijah.jpg", description: "Prophet of fire." },
  { id: 19, name: "Elisha", image: "https://speaktoheaven.com/img/elisha.jpg", description: "Prophet of compassion." },
  { id: 20, name: "Job", image: "https://speaktoheaven.com/img/job.jpg", description: "Man of endurance." },
  { id: 21, name: "Samuel", image: "https://speaktoheaven.com/img/samuel.jpg", description: "Prophet who anointed kings." },
  { id: 22, name: "Ruth", image: "https://speaktoheaven.com/img/ruth.jpg", description: "Model of loyalty." },
  { id: 23, name: "Esther", image: "https://speaktoheaven.com/img/esther.jpg", description: "Queen who saved Israel." },
  { id: 24, name: "Apostle Peter", image: "https://speaktoheaven.com/img/peter.jpg", description: "Bold apostle." },
  { id: 25, name: "Apostle Paul", image: "https://speaktoheaven.com/img/paul.jpg", description: "Teacher and missionary." },
  { id: 26, name: "Apostle John", image: "https://speaktoheaven.com/img/john.jpg", description: "Apostle of love." }
];
