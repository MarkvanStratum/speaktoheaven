...
export const biblicalProfiles = [
  ...
  { id: 6, name: "Abraham", image: "/img/abraham.jpg", description: "Father of faith." },
  { id: 7, name: "Isaac", image: "/img/isaac.jpg", description: "Child of promise." },
  { id: 8, name: "Jacob", image: "/img/jacob.jpg", description: "Father of the twelve tribes." },
  { id: 9, name: "Noah", image: "/img/noah.jpg", description: "Builder of the ark." },
  { id: 10, name: "Adam", image: "/img/adam.jpg", description: "First man." },
  ...
  { id: 13, name: "Solomon", image: "/img/sol.jpg", description: "King of wisdom." },
  { id: 14, name: "Isaiah", image: "/img/isaiah.jpg", description: "Major prophet." },
  { id: 15, name: "Jeremiah", image: "/img/jeremiah.jpg", description: "Prophet of warning and hope." },
  { id: 16, name: "Ezekiel", image: "/img/eze.jpg", description: "Prophet of visions." },
  { id: 17, name: "Daniel", image: "/img/daniel.jpg", description: "Interpreter of dreams." },
  { id: 18, name: "Elijah", image: "/img/elijah.jpg", description: "Prophet of fire." },
  { id: 19, name: "Elisha", image: "/img/elisha.jpg", description: "Prophet of compassion." },
  { id: 20, name: "Job", image: "/img/job.jpg", description: "Man of endurance." },
  { id: 21, name: "Samuel", image: "/img/sam.jpg", description: "Prophet who anointed kings." },
  { id: 22, name: "Ruth", image: "/img/rut.jpg", description: "Model of loyalty." },
  { id: 23, name: "Esther", image: "/img/esther.jpg", description: "Queen who saved Israel." },
